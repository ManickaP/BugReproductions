...
Timer _cleaningTimer = new Timer((_) => RemoveStalePools(), null, TimeSpan.FromMilliseconds(1000), Timeout.InfiniteTimeSpan);
Thread.Sleep(1010);
_cleaningTimer.Change(TimeSpan.FromSeconds(2), Timeout.InfiniteTimeSpan);
Thread.Sleep(TimeSpan.FromSeconds(15));